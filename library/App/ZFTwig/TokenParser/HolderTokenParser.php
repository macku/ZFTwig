 ...
 */
class App_ZFTwig_TokenParser_HolderTokenParser extends Twig_TokenParser
{
    /**
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new App_ZFTwig_Node_HolderNode($placeholder, $attributes, $lineno, $this->getTag());
    }
