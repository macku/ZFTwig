 ...
 */
class App_ZFTwig_TokenParser_JavascriptTokenParser extends Twig_TokenParser
{
    /**
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new App_ZFTwig_Node_JavascriptNode($expr, $options, $token->getLine(), $this->getTag());
    }
