 ...
 */
class App_ZFTwig_TokenParser_StylesheetTokenParser extends Twig_TokenParser
{
    /**
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new App_ZFTwig_Node_StylesheetNode($expr, $options, $token->getLine(), $this->getTag());
    }
