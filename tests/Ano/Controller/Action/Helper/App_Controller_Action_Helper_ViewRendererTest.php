...
require_once 'App/Controller/Action/Helper/ViewRenderer.php';
require_once 'Zend/Controller/Front.php';
require_once 'Zend/Controller/Request/Http.php';
require_once 'Zend/Controller/Response/Http.php';
require_once 'Zend/Filter/Inflector.php';
require_once 'App/View.php';
require_once 'App/View/Engine/PhpEngine.php';
 ...
 */
class App_Controller_Action_Helper_ViewRendererTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testPredispatchWithTwigTemplateEngine()
    {
        ...
        $this->helper->setActionController($controller);
        $view = new App_View();
        $engine = new App_View_Engine_PhpEngine($view);
